...
contrasts2 = ['sentence reading vs checkerboard']
...
k_range = [10, 20, 30, 40, 50, 70, 100, 150, 200, 300, 400, 500]

if do_parcel_cv:
    method = 'ward'
    print method
    for method in ['kmeans', 'geometric']:
        print method
        llr = parcel_cv(
