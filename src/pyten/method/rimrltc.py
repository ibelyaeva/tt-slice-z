...
from pyten.tools.tenerror import  cost
from pyten.tools.tenerror import  tsc
...
def rimrltc(x, x_true, omega=None, alpha=None, beta=None, max_iter=100, epsilon=1e-16, printitn=100):
    ...
    for k in range(max_iter):
        ...
        rse_error_list.append(errList[k])
        ...
        cost_err = cost(x, x_true, omega)
        tcs_err = tsc(x.data , x_true.data, omega)
        
        cost_error_list.append(cost_err)
        tcs_error_list.append(tcs_err)
    ...
    return x, rse_error_list, cost_error_list, tcs_error_list
